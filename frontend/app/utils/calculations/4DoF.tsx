...
const run4DoFSimulation = (
  ...
  while (currentTime <= maxTime) {
    ...
    if (isLaunchClear) {
      ...
      const longitudinalForce = normalForce + weightForce * cos;
      ...
      velocity.x +=
        (axialAcceleration * cos - longitudinalForce * sin) * timeStep;
      velocity.y +=
        (axialAcceleration * sin + longitudinalForce * cos) * timeStep;
      ...
      const moment =
        preMomentCalc * spec.Cmq * omega + normalForce * (spec.CPlen - CG);
      omega += (moment / spec.Iyz) * timeStep; // update angular velocity
