 ...
 * Based on provided SVG design
 */
const Hourglass: React.FC<FilledIconProps> = ({
  className,
  size = undefined,
  color = "currentColor",
}) => {
  return (
    ...
    >
      <path
        d="M315.884,231.154l82.754-115.142c7.152-9.944,11.038-21.785,11.038-33.92V46.12h23.912V0H78.412v46.12h23.912
