...
const Rocket: React.FC<FilledIconProps> = ({
  className,
  size = undefined,
  color = "currentColor",
}) => {
  return (
    ...
    >
      <g>
        <polygon points="219.363,109.356 113.285,237.075 0.003,250.793 85.082,139.59 	"></polygon>
        <polygon points="402.644,292.637 274.925,398.715 261.207,511.996 372.41,426.934 	"></polygon>
        <path
